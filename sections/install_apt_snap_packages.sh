...
main_install_snap_packages() {
  ...
  sudo -u "$ORIGINAL_USER" mkdir -p /home/$ORIGINAL_USER/.config/Code
  sudo -u "$ORIGINAL_USER" env HOME="/home/$ORIGINAL_USER" code --install-extension eamodio.gitlens
  sudo -u "$ORIGINAL_USER" env HOME="/home/$ORIGINAL_USER" code --install-extension ms-python.python
  sudo -u "$ORIGINAL_USER" env HOME="/home/$ORIGINAL_USER" code --install-extension charliermarsh.ruff
}
